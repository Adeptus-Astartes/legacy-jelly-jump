...
#region PUBLIC_CLASSES
	...
	void Awake()
	{
		if(IsMeshValid())
		{
			...
			if(Application.isPlaying)
			{
				...
				m_ReferencePointParent.transform.position = transform.position;
				//m_ReferencePointParent.transform.parent = transform.parent;
	...
	void Update()
	{
		if(m_ReferencePoints != null)
		{
			...
			this.transform.localPosition = m_CentralPoint.GameObject.transform.position;
			this.transform.localRotation = m_CentralPoint.GameObject.transform.rotation;
